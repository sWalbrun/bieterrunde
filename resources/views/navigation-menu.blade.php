...
<div x-show="sidebarIsOpened" class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-green-400">
    <div class="absolute top-0 right-0 -mr-12 pt-2">
        <button @click="sidebarIsOpened = false" type="button" class="ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
...
<div class="lg:pl-64 flex flex-col flex-1">
    <div class="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:border-none">
        <button type="button" class="px-4 border-r border-gray-200 text-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-cyan-500 lg:hidden" @click="sidebarIsOpened = true">
        ...
        <div class="flex-1 px-4 flex justify-between sm:px-6 lg:max-w-6xl lg:mx-auto lg:px-8">
            <div class="flex-1 flex">
                <form class="w-full flex md:ml-0" action="#" method="GET">
                    ...
                    <div class="relative w-full text-gray-400 focus-within:text-gray-600">
                        ...
                        <input id="search-field" name="search-field" class="block w-full h-full pl-8 pr-3 py-2 border-transparent text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-0 focus:border-transparent sm:text-sm" placeholder="Suche" type="search">
                    </div>
                </form>
            </div>
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <div x-data="{menuIsShown:false}" class="ml-3 relative">
                    <div>
                        <button type="button" @click="menuIsShown = !menuIsShown" class="max-w-xs bg-white rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 lg:p-2 lg:rounded-md lg:hover:bg-gray-50" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <div x-show="menuIsShown" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
